...
public class OptimizerExample implements cc.mallet.optimize.Optimizable.ByGradientValue {
    ...
    public OptimizerExample(String[] cmd) {
        parameters = new double[2];
        parameters[0] = new Double(cmd[0]);
        parameters[1] = new Double(cmd[1]);
    }
